...
Route::get('/crear', function () {
    return view('panel/posts/crear');
});
Route::post("/crearpost" , "panel\PostsController@crear");
/**
...
Route::group(['middleware'=>'auth', 'as' => 'panel::'], function() {
  ...
  Route::get('/detallepost', 'Panel\PostsController@detallepost')->name('posts.detallepost');


  // Route::get('crear', 'Panel\PostsController@index')->name('posts.crear');
  /**
